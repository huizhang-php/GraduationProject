...
class RedisTool{
	...
	public function __construct(){
	    $redisConfig = SelfConfig::getConfig('Source.redis');
		$this->redis = new \Redis();
		$this->redis->connect($redisConfig['host'],$redisConfig['port'],0);
	}
	//===================string========================
	/**
	 * 创建一个string类型的缓存
	 ...
	 */
	public function setStr($key = '',$value = '',$time = 60){
